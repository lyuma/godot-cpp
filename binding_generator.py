...
def generate_class_header(used_classes, c):
    ...
    source.append("\tstatic void *___class_tag;")
    source.append("")
    source.append("public:")
    source.append("\tstatic void ___init_method_bindings();")

    # class id from core engine for casting
    source.append("\tinline static size_t ___get_id() { return (size_t)___class_tag; }")
...
def generate_class_implementation(icalls, used_classes, c):
    ...
    source.append("void *" + class_name + "::___class_tag = nullptr;")
    source.append("")
    ...
    source.append("\t___class_tag = godot::core_1_2_api->godot_get_class_tag(&class_name);")
